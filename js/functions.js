    ...
    //     Get nomogram value From Drop Down
        ...
        calculate = function(weight,nomogram,SecOne,SecTwo) {
          // alert('weight'+weight+'nomo '+nomogram+' aPTT '+aPTT+'target'+targetaPTT);
            ...
            $("#results").show();
             var infusionRate = "<p><i class=\"fa fa-exclamation-triangle fa-2x\" aria-hidden=\"true\"> </i>  0.5 mcg/kg/min ( "+(weight * 0.5 * 60/1000)+" mL\/hr ); <\/span> check aPTT 2 hrs after start of infusion, then adjust rate of infusion as follows:<\/p>";
               ...
               $("#cNext_R5").html(cNext_R5);
                ...
                $("#results").show();
               var infusionRate = "<p><i class=\"fa fa-exclamation-triangle fa-2x\" aria-hidden=\"true\"> </i>  2 mcg/kg/min ( "+(weight * 2 * 60/1000)+" mL\/hr ); <\/span> check aPTT 2 hrs after start of infusion, then adjust rate of infusion as follows:";
